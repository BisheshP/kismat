...
class billing_system:
    def __init__(self, root):
        ...
        image = image.resize((90, 70), Image.ANTIALIAS)
        photo = ImageTk.PhotoImage(image)

        label = Label(frm1,image=photo)
     ...
     # totalwithtax
        ...
        Button(frm, width=9, text="Search",command=self.findbill, font="arial 15 bold", bd=5).grid(row=0, column=9, padx=0)

        frm1 = LabelFrame(self.root, bd=7, relief=SUNKEN, text="Personal care", font=("times new roman", 17, "bold"),
                          fg="yellow", bg=bg_color)
        frm1.place(x=3, y=190, width=333, height=470)
        ...
        frm2 = LabelFrame(self.root, bd=7, relief=SUNKEN, text="Various groceries",
                          ...
                          fg="yellow", bg=bg_color)
        frm2.place(x=330, y=190, width=310, height=470)
        ...
        frm3 = LabelFrame(self.root, bd=7, relief=SUNKEN, text="Snacks",
                          font=("times new roman", 17, "bold"),
                          fg="yellow", bg=bg_color)
        frm3.place(x=635, y=190, width=310, height=470)
        ...
        frm4 = LabelFrame(self.root, bd=7, relief=SUNKEN, text="Fresh vegetables",
                          font=("times new roman", 17, "bold"),
                          fg="yellow", bg=bg_color)
        frm4.place(x=937, y=190, width=300, height=470)
        ...
        frm5 = LabelFrame(self.root, bd=7, relief=SUNKEN, text="Beverages",
                          font=("times new roman", 17, "bold"),
                          fg="yellow", bg=bg_color)
        frm5.place(x=1190, y=190, width=310, height=470)
